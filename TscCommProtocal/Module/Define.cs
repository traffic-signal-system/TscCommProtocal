...
namespace TscCommProtocal.Module
{
    public class Define
    {
        ...
        //485 不输出
        public static byte[] SET_COUNTDOWN_485_NOOUT = { SET_REQUEST_RESPONSE, CNTDOWNDEV, 0xff, 0x00 };
        //正常输出倒计时，通信式
        public static byte[] SET_COUNTDOWN_485_NORMAL = { SET_REQUEST_RESPONSE, CNTDOWNDEV, 0xff, 0x03 };
        //15秒前都黑屏，15秒后开始倒计时
        public static byte[] SET_COUNTDOWN_485_15DOWN = { SET_REQUEST_RESPONSE, CNTDOWNDEV, 0xff, 0x01 };
        //倒计时运行到8秒，停止。直到最后8秒的时候，开始倒计时
        public static byte[] SET_COUNTDOWN_485_KEEP8 = { SET_REQUEST_RESPONSE, CNTDOWNDEV, 0xff, 0x02 };

        //信号状态监控
        public static byte[] GET_TSC_STATUS_POWER_DOOR_TEMP = { GET_REQUEST, 0xf5, 00 };
        ...
        public static byte[] DETECTOR_SENSITIVITY_2 = { SET_REQUEST_RESPONSE, OSCILLATOR_FREQUENCY_SENSITIVITY, 0x00, 0x0b, 0x01 };
        ...
        //通信接口部分，主要为ISO通信层协议
        public static byte[] TSC_MODIFY_COMM_NULL_IPV4 = { SET_REQUEST_RESPONSE, 0xf6, 0x04, 0x01 };
        public static byte[] TSC_MODIFY_COMM_NULL_IPV6 = { SET_REQUEST_RESPONSE, 0xf6, 0x04, 0x05 };
        public static byte[] TSC_MODIFY_COMM_UDP_IPV4 = { SET_REQUEST_RESPONSE, 0xf6, 0x04, 0x00 };
        public static byte[] TSC_MODIFY_COMM_TCP_IPV4 = { SET_REQUEST_RESPONSE, 0xf6, 0x04, 0x02 };
        public static byte[] TSC_MODIFY_COMM_UDP_IPV6 = { SET_REQUEST_RESPONSE, 0xf6, 0x04, 0x04 };
        public static byte[] TSC_MODIFY_COMM_TCP_IPV6 = { SET_REQUEST_RESPONSE, 0xf6, 0x04, 0x06 };
        //修改端口 、、后跟两个字节   54 35 都是16进制
        public static byte[] TSC_MODIFY_PORT = { SET_REQUEST_RESPONSE, 0xf6, 0x05 };
        //修改IP地址
        public static byte[] TSC_MODIFY_IP = { SET_REQUEST_RESPONSE, 0xf6, 0x06 };
        //修改子网掩码
        public static byte[] TSC_MODIFY_MASK = { SET_REQUEST_RESPONSE, 0xf6, 0x07 };
        //修改网关
        public static byte[] TSC_MODIFY_GATEWAY = { SET_REQUEST_RESPONSE, 0xf6, 0x08 };
        ...
        //上位机界面（显示倒计时），
        public static byte[] TSC_COUNTDOWN_ENABLE = { SET_REQUEST_RESPONSE, 0xe6, 0x00, 0x01 };
        public static byte[] TSC_COUNTDOWN_DISABLE = { SET_REQUEST_RESPONSE, 0xe6, 0x00, 0x00 };

        //重起信号机
        public static byte[] TSC_REBOOT = { SET_REQUEST_RESPONSE, 0xf6, 0x01, 0x00, 0x01 };
        ...
        //public static byte[] TSC_CONTROL_REBOOT = { SET_REQUEST_RESPONSE, 0xf6, 0x01, 0x04, 0x00 };

        public static byte[] TSC_DEVICE_DOWN_COLD_ENABLED = { SET_REQUEST_RESPONSE, 0xf6, 0x02, 0x00, 0x00, 0x00, 0x08 };
        public static byte[] TSC_DEVICE_UP_HOT_ENABLED = { SET_REQUEST_RESPONSE, 0xf6, 0x02, 0x00, 0x00, 0x00, 0x10 };
        public static byte[] TSC_DEVICE_ENABLED = { SET_REQUEST_RESPONSE, 0xf6, 0x02, 0x00, 0x00, 0x00, 0x08 };
